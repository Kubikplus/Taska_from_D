...
import com.localazy.quicknote.drawOverOtherAppsEnabled
import com.localazy.quicknote.startPermissionActivity
...
class FloatingService:Service() {
    ...
    private fun showNotification(){
        ...
        val exitPendingIntent = PendingIntent.getService(
            this, CODE_EXIT_INTENT, exitIntent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT
        )

        val notePendingIntent = PendingIntent.getService(this, CODE_NOTE_INTENT, noteIntent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        with(
            ...
            setSmallIcon(R.drawable.baseline_highlight_off_black_24)
